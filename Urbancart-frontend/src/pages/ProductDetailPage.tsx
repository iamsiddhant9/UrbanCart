...
const MOCK_PRODUCTS: Record<number, Product> = {
  1: { id: 1, category_id: 1, name: "Linen Throw Pillow",    brand: "Maison",       price: 1299, old_price: 1799, badge: "Sale", stock: 12, image_url: null, description: "Handwoven linen pillow with a natural texture that complements any living space. Available in a range of muted tones." },
  2: { id: 2, category_id: 1, name: "Ceramic Pour-Over Set", brand: "Kiln & Co",    price: 2499, old_price: null, badge: "New",  stock: 8,  image_url: null, description: "Handcrafted ceramic pour-over set. Each piece is unique, with subtle glaze variations. Includes dripper, carafe, and two mugs." },
  ...
  8: { id: 8, category_id: 4, name: "Bamboo Brush Set",      brand: "Green Ritual", price: 749,  old_price: 999,  badge: "Sale", stock: 15, image_url: null, description: "Zero-waste bamboo brush set — face brush, kabuki, and blender. Soft synthetic bristles, plastic-free packaging." },
};
...
export default function ProductDetailPage() {
  ...
  const handleBuyNow = () => {
    handleAdd();
    setTimeout(() => navigate(user ? "/cart" : "/login"), 300);
  };
